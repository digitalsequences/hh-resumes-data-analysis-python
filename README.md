...
### [Основной датасет](https://drive.google.com/file/d/1Mub5r_-TAIeeomd-kqYQXxHWjSn1xkR0/view) (`dst-3.0_16_1_hh_database.csv`)
- **Объем:** 47k+ резюме
...
### [Курсы валют](https://drive.google.com/file/d/1qyHrC3W64SBKWSXKMQorspAkN-_4O7q6/view) (`ExchangeRates.csv`)
Используется для конвертации зарплатных ожиданий в иностранной валюте (USD, EUR) в рубли по актуальным курсам для единообразного анализа.
...
- **Возраст**: основная масса соискателей (50%) в возрасте 27-36 лет, модальное значение - 30 лет
- **Опыт работы**: большинство имеют опыт 4.7-12.8 лет, модальное значение - 6.8 лет
- **Зарплатные ожидания**: 50% соискателей ожидают 37-95 тыс. рублей

### Зависимости:
- **Образование**: высшее образование коррелирует с более высокими зарплатными ожиданиями
- **Город**: самые высокие ожидания в Москве и Санкт-Петербурге
- **Мобильность**: готовность к переезду и командировкам повышает зарплатные ожидания
- **Возраст и опыт**: наблюдаются аномалии, где опыт превышает возраст соискателя
